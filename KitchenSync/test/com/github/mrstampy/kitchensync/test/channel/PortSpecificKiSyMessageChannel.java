...
/**
 * The Class PortSpecificKiSyMessageChannel.
 */
public class PortSpecificKiSyMessageChannel extends
		AbstractPortSpecificKiSyChannel<KiSyMessageByteBufCreator, KiSyMessageInitializer, NioDatagramChannel> {
	 ...
	 * @param port the port
	 */
	public PortSpecificKiSyMessageChannel(int port) {
		super(port);
	}
